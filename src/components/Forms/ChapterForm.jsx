...
const ChapterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://your-api-endpoint.com/api/chapters', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-2xl mx-auto mt-8">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Add New Chapter</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Chapter Name */}
        <div>
          <label className="block font-semibold text-lg mb-2">Chapter Name</label>
          <input
            type="text"
            value={chapterName}
