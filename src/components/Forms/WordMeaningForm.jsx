...
const WordMeaningForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://your-api-endpoint.com/api/word-meanings', {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg max-w-3xl mx-auto mt-8">
      <h2 className="text-3xl font-bold mb-6 text-center text-gray-800">Add New Words</h2>
