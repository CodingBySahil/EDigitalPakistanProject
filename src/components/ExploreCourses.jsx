...
const ExploreCourses = ({ levelOfClass }) => {
  ...
  return (
    <>
      <div className="overflow-hidden bg-[#ebf5ff] py-8">
        {/* Class Title */}
        ...
        <div className="flex justify-between">
          ...
          <div className="relative grid grid-cols-4 gap-4 md:grid-cols-9 lg:grid-cols-12">
            {[
              "English",
              "General Science",
              "Islamiat",
              ...
              return (
                <div key={index} className="flex hover:min-w-[50rem]">
                  <div
                  ...
                  >
                    <div
                      className={`flex h-[20rem]  -rotate-[8deg] transform rounded-lg bg-white p-2 shadow-lg transition-all duration-300 ease-in-out ${
                    ...
                    >
                      ...
                      <div>
                        ...
                        {isHovered && (
                          <div className="hover:scale-103 max-h-full w-96 transform p-2 transition-all duration-300 ease-in-out hover:shadow-2xl md:p-4">
                            <div className="animate-fadeIn flex h-72 rounded-lg bg-white p-4 opacity-0 shadow-lg">
                              ...
                              <div>
                                ...
                                <div className="md:text-sm text-xs text-gray-600">
                                  Course textbooks, include all subjects taught in
                                  Govt. schools.
                                </div>
