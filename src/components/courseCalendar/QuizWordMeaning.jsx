...
export default function QuizWordMeaning() {
  ...
  if (statusWordMeanings === "success") {
    return (
      <div
        className="w-[100%] px-[10px] pb-[30px] overflow-y-auto overflow-x-hidden flex justify-center pt-[30px] tabS:px-[60px] laptop14:pl-[60px] laptop14:pr-[200px] laptop14:w-[70%]"
